                ...
                <div>
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <div class="mt-2">
                                <input type="text" name="name" id="first-name" autocomplete="given-name" class="block w-full border-b-2 border-my-light outline-none py-1.5" placeholder="First Name" required>
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <div class="mt-2">
                                <input type="text" name="surname" id="last-name" autocomplete="family-name" class="block w-full border-b-2 border-my-light outline-none py-1.5" placeholder="Last Name" required>
                            </div>
                        </div>
